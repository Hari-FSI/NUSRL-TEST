...
<h4 className="mb_15">Seminar on World Intellectual Property Day</h4>
...
</ul><h4 className="mb_15 mt_15">Our recent endeavour includes:</h4>
...
<h4 className="mb_15">Office Bearers:</h4>
