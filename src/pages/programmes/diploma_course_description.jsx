...
const diploma_admissions = () => {
  ...
  <div className="pdfs_as_list">
    <div className="list_of_pdf_titles">
      ...
      <p className="active"><Link href="/programmes/diploma_course_description">Diploma Course Description</Link></p>
    ...
    <h4 className="mb_15">Diploma Course Description</h4>
...
export default diploma_admissions