...
<div className="text_para mt_30">
  ...
  <h3>RULES OF CONDUCT — HALLS OF RESIDENCE</h3>

<p className="mt_30"><strong>(I) WARDEN</strong><br />
...
<p><strong>(II) CHIEF WARDEN AND COMMITTEE OF WARDENS</strong><br />
...
</ul><p><strong>(III) DINING HALL CONDUCT</strong><br />
...
<p><strong>(IV) HALLS OF RESIDENCE (HOR) COMMITTEE</strong><br />
...
<p><strong>(VII) PROHIBITION</strong><br />
...
<p><strong>(VII) OBSCENE AND INDECENT BEHAVIOR</strong><br />
...
<p><strong>(VIII) EVE TEASING AND DEROGATORY PRACTICES</strong><br />
...
<p><strong>(IX) MAINTENANCE AND INFRASTRUCTURE</strong><br />
...
<p><strong>(X) REFERENCE</strong><br />
...
<p><strong>(XI) PROTOCOL</strong><br />
...
<p><strong>(XII) FINALITY</strong><br />
