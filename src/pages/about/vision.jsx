...
const vision = () => {
  ...
  return (
    ...
    <Image 
      className="w100 mt_30 mb_15"
      src="/images/inner-banner-1.webp"
      alt="building"
      width={240}
      height={360}
      />
    ...
    <p>The present era and education system needed for it require a new set of responses, innovations and specializations,
      ...
      <h4 className="mt_30">Keeping in view the available resources and prospect of getting more funds from the State or
