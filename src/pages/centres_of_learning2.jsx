...
const centres_of_learning = () => {
  ...
  <div className="pdfs_as_list">
    ...
    <h4 className="mb_15 mt_15">Centre&nbsp;for Legal Aid Programme</h4>
...
<h4 className="mb_15 mt_15">Centre for Study and Research in Tribal Rights (CSRTR)</h4>
...
<h4 className="mb_15 mt_15">Centre for Study and Research in Child Rights (CSRCR)</h4>
...
<h4 className="mb_15 mt_15">Centre for Study and Research in Intellectual Property Rights</h4>
...
<h4 className="mb_15 mt_15">Seminar on World Intellectual Property Day</h4>
